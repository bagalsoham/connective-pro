  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllUsers.pending, (state) => {
        state.isLoading = true;
        state.all_profile_fetched = false; // reset before fetching
      })
      .addCase(getAllUsers.fulfilled, (state, action) => {
        state.isLoading = false;
        state.allUsers = action.payload.users || [];
        state.all_profile_fetched = true; // ✅ mark as fetched
      })
...
// Export the actions
export const { reset, handleLoginUser, setTokenIsNotThere, setTokenIsThere } =
  authSlice.actions;
